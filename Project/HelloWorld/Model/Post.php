 ...
 */
namespace Project\HelloWorld\Model;
...
class Post extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'project_helloworld_post';
     ...
     * @var string
     */
    protected $_cacheTag = 'project_helloworld_post';
     ...
     * @var string
     */
    protected $_eventPrefix = 'project_helloworld_post';
    ...
    {
        $this->_init('Project\HelloWorld\Model\ResourceModel\Post');
    }
