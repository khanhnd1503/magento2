...
**Magento 2 Module development** or **Magento 2 Hello World Simple Module** trends is increase rapidly while Magento release official version. That why we - **Project** - are wring about a topic that introduces how to create a simple **Hello World module in Magento 2**.
...
In this module, we will use `Project` for Vendor name and `HelloWorld` for ModuleName. So we need to make this folder:
`app/code/Project/HelloWorld`
...
~~~
app/code/Project/HelloWorld/etc/module.xml
~~~
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="urn:magento:framework:Module/etc/module.xsd">
    <module name="Project_HelloWorld" setup_version="1.0.0" />
</config>
~~~

In this file, we register a module with name `Project_HelloWorld` and the version is `1.0.0`.
...
~~~
app/code/Project/HelloWorld/registration.php
~~~
...
~~~
php bin/magento module:enable Project_HelloWorld
~~~
...
~~~
app/code/Project/HelloWorld/etc/frontend/routes.xml
~~~
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="urn:magento:framework:App/etc/routes.xsd">
    <router id="standard">
        <route id="project" frontName="helloworld">
            <module name="Project_HelloWorld" />
        </route>
    </router>
</config>
~~~
...
~~~
app/code/Project/HelloWorld/Controller/Index/Display.php
~~~
